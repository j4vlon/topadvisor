            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9" style="margin-bottom: 20px">
                        ...
                        @enderror
                        <input type="text" class="form-control" name="meta_title" placeholder="Мета название" value="{{ $news->meta_title }}">
                    </div>
                    ...
                    <div class="col-sm-9" style="margin-bottom: 20px">
                        ...
                        <textarea class="form-control {{ $errors->has('meta_descr') ? 'is-invalid' : '' }}" name="meta_descr"
                                  placeholder="Мета описание">{!! $news->meta_descr !!}</textarea>
                    </div>
                    <label for="title" class="col-sm-3 text-end control-label col-form-label">Название новости</label>
                    <div class="col-sm-9" style="margin-bottom: 20px">
                        @error('title')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                        <input type="text" class="form-control" name="title" placeholder="Введите название новости" value="{{ $news->title }}">
                    </div>
                    ...
                    <div class="col-sm-9" style="margin-bottom: 20px">
                        ...
                        <input type="file" name="file_url" onchange="changeImg(event)"
                               value="{{ $news->file_url }}" class="form-control {{ $errors->has('file_url') ? 'is-invalid' : '' }}">
                        <img width="300px" class="change-img" src="{{ $news->file_url }}">
                    </div>
