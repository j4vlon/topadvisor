            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9" style="margin-bottom: 20px">
                        ...
                        @enderror
                        <input type="text" class="form-control" name="meta_title" placeholder="Название статьи" value="{{ $subservice->meta_title }}">
                    </div>
                    ...
                    <div class="col-sm-9" style="margin-bottom: 20px">
                        ...
                        >{{ $subservice->meta_descr }}</textarea>
                    </div>
                    ...
                    <div class="col-sm-9" style="margin-bottom: 20px">
                        ...
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                        <input type="text" class="form-control {{ $errors->has('form_title') ? 'is-invalid' : '' }}" name="subtitle" placeholder="Введите текст подзаголовки" value="{{ $subservice->subtitle }}">
                    </div>
