            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9" style="margin-bottom: 20px">
                        ...
                        @enderror
                        <select name="infodirection_id" class="select2 form-select shadow-none select2-hidden-accessible {{ $errors->has('infodirection_id') ? 'is-invalid' : '' }}" style="width: 100%; height: 36px" data-select2-id="1" tabindex="-1" aria-hidden="true">
