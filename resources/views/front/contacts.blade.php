                        ...
                        <div class="social-icons">
                            <div class="facebook">
                                <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="17.5" cy="17.5" r="16.75" transform="rotate(-180 17.5 17.5)" stroke="#D2D2D4"
                                            stroke-width="1.5" />
                                    <path
                                        ...
                                        stroke="#D2D2D4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                            <div class="instagram">
                                <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path
                                        ...
                                        stroke="#D2D2D4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M21.7188 13.2812V13.2822" stroke="#D2D2D4" stroke-width="1.5" stroke-linecap="round"
                            ...
                            <div class="telegram">
                                <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="17.5" cy="17.5" r="16.75" transform="rotate(-180 17.5 17.5)" stroke="#D2D2D4"
                                            stroke-width="1.5" />
                                    <path d="M19 16L15 20L21 26L25 10L7 17L11 19L13 25L16 21" stroke="#D2D2D4" stroke-width="1.5"
                                          stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                        </div>
                        <div class="address">
                            <p>Адрес: Узбекистан, 100060, Ташкент, Мирабадский район, ул. Т. Шевченко, 42, Ориентир: Школа №94</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6">
