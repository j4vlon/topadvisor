...
@section('content')
    ...
    <div class="container">
        ...
        <div class="business-info">
            ...
            <a href="" class="service-consulting more-btn"><span>Консультация</span><svg width="11" height="11" viewBox="0 0 11 11"
                        ...
                        <div class="row accordion-content">
                            ...
                            <div class="col-xl-8 col-lg-8 accordion-descr-wrapper">
                                ...
                                <div class="d-flex">
                                    ...
                                    <a class="more-btn-white more-btn" href="{{ route('category', $subservice->slug) }}">
                                        <span>Узнать подробнее</span><svg width="11" height="11" viewBox="0 0 11 11" fill="none"
                                                                         xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1.99988 1H9.99988M9.99988 1V9M9.99988 1L0.999878 10" stroke="black"
                                                  stroke-width="1.5" />
                                        </svg>
                                    </a>
